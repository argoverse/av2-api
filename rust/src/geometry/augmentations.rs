...
pub fn sample_global_reflect_pose_x(xyzlwh_qwxyz: Array<f32, Ix2>, p: f64) -> Array<f32, Ix2> {
...
pub fn sample_global_reflect_pose_y(xyzlwh_qwxyz: Array<f32, Ix2>, p: f64) -> Array<f32, Ix2> {
    let d = Bernoulli::new(p).unwrap();
    if d.sample(&mut rand::thread_rng()) {

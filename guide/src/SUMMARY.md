...
- [Tasks](./tasks/README.md)
    - [3D Object Detection](./tasks/3d_object_detection/README.md)
        ...
        - [Submission Format](./tasks/3d_object_detection/submission_format.md)
    ...
    - [3D Tracking](./tasks/3d_tracking/README.md)
        - [Evaluation](./tasks/3d_tracking/evaluation.md)
        - [Submission Format](./tasks/3d_tracking/submission_format.md)
    - [3D Scene Flow](./tasks/3d_scene_flow/README.md)
        - [Evaluation](./tasks/3d_scene_flow/evaluation.md)
        - [Submission Format](./tasks/3d_scene_flow/submission_format.md)

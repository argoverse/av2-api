...
from av2.geometry.geometry import crop_xyz, xy_to_uv
...
def xyz_to_bev(
    ...
    indices_cropped, grid_boundary_reduction = crop_xyz(
    ...
    width = voxel_grid_size_m[0]
    height = voxel_grid_size_m[1]
    uv = xy_to_uv(indices_cropped[:, :2], width, height)

...
All faces and license plates, whether inside vehicles or outside of the driveable area, are blurred extensively to preserve privacy.
...
The AV2 Sensor Dataset contains 10 Hz 3D cuboid annotations for objects within our 30 class taxonomy. Objects are annotated if they are within the “region of interest” (ROI) – within five meters of the mapped “driveable” area. These 30 classes are defined as follows, appearing in order of frequency:

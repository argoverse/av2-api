...
HIERARCHY : Final[dict] = {"FINEGRAIN" : ['REGULAR_VEHICLE', 'LARGE_VEHICLE', 'BUS', 'BOX_TRUCK', 'TRUCK', 'VEHICULAR_TRAILER', 'TRUCK_CAB', 'SCHOOL_BUS', 'ARTICULATED_BUS',
                    ...
                    "GROUP" : ['VEHICLE', 'VEHICLE', 'VEHICLE', 'VEHICLE', 'VEHICLE', 'VEHICLE', 'VEHICLE', 'VEHICLE', 'VEHICLE',
                                'VULNERABLE', 'VULNERABLE', 'VULNERABLE', 'VULNERABLE', 'VULNERABLE', 'VULNERABLE', 'VULNERABLE', 'VULNERABLE', 'VULNERABLE', 'VULNERABLE', 'VULNERABLE',
...
LCA: Final[dict[List]] = {
    ...
    "VEHICLE" : ['REGULAR_VEHICLE', 'LARGE_VEHICLE', 'BUS', 'BOX_TRUCK', 'TRUCK', 'VEHICULAR_TRAILER', 'TRUCK_CAB', 'SCHOOL_BUS', 'ARTICULATED_BUS',],
    "VULNERABLE" : ['PEDESTRIAN', 'WHEELED_RIDER', 'BICYCLE', 'BICYCLIST', 'MOTORCYCLE', 'MOTORCYCLIST', 'WHEELED_DEVICE', 'WHEELED_RIDER', 'WHEELCHAIR', 'STROLLER', 'DOG'],
    "MOVABLE" : ['BOLLARD', 'CONSTRUCTION_CONE', 'SIGN', 'CONSTRUCTION_BARREL', 'STOP_SIGN', 'MOBILE_PEDESTRIAN_CROSSING_SIGN', 'MESSAGE_BOARD_TRAILER'],
    "OBJECT" : ['REGULAR_VEHICLE', 'LARGE_VEHICLE', 'BUS', 'BOX_TRUCK', 'TRUCK', 'VEHICULAR_TRAILER', 'TRUCK_CAB', 'SCHOOL_BUS', 'ARTICULATED_BUS',
                'PEDESTRIAN', 'WHEELED_RIDER', 'BICYCLE', 'BICYCLIST', 'MOTORCYCLE', 'MOTORCYCLIST', 'WHEELED_DEVICE', 'WHEELED_RIDER', 'WHEELCHAIR', 'STROLLER', 'DOG',
                'BOLLARD', 'CONSTRUCTION_CONE', 'SIGN', 'CONSTRUCTION_BARREL', 'STOP_SIGN', 'MOBILE_PEDESTRIAN_CROSSING_SIGN', 'MESSAGE_BOARD_TRAILER']
}

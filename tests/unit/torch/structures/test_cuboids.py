...
def test_build_cuboids() -> None:
    ...
    cuboids_npy = annotations_frame[list(XYZLWH_QWXYZ_COLUMNS)].to_numpy().astype(np.float32)
    ...
    assert_close(cuboids.as_tensor(cuboid_mode=CuboidMode.XYZLWH_QWXYZ), cuboids_xyzlwh_qwxyz)

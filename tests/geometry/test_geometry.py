...
@pytest.mark.parametrize(
    "points_xyz, lower_bound_inclusive, upper_bound_exclusive, expected_crop_xyz, expected_mask",
    [
        (
...
def test_crop_xyz(
    ...
    Args:
        ...
        expected_crop_xyz: (...,3) Expected tuple of cropped Cartesian coordinates.
        expected_mask: (...,) Expected boolean mask.
    """
    cropped_xyz, mask = geometry_utils.crop_xyz(points_xyz, lower_bound_inclusive, upper_bound_exclusive)

    assert np.array_equal(expected_crop_xyz, cropped_xyz)

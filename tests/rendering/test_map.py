...
def test_draw_visible_polyline_segments_cv2_some_visible() -> None:
    ...
    line_segments_arr: NDArrayInt = np.array([[50, 0], [50, 20], [50, 40], [50, 60], [50, 80], [60, 120]])
    ...
    map_rendering_utils.draw_visible_polyline_segments_cv2(
        line_segments_arr=line_segments_arr, valid_pts_bool=valid_pts_bool, image=img_bgr, color=RED_BGR, thickness_px=2
    )
    if visualize:
